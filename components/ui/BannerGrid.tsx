...
export default function BannnerGrid(props: Props) {
  ...
  return (
    <section class="container w-full px-4 md:px-0 mx-auto max-w-[1502px] lg-desktop:px-8 full-phone:px-0">
      <div
        class={`grid gap-4 md:gap-2 ${
      ...
      >
        {banners.map(({ href, srcMobile, srcDesktop, alt }, index) => (
          <a
            href={href}
            class={`Home-bannerGrid-${index + 1}-cy overflow-hidden ${
